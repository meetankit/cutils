...
import com.adobe.dx.aep.skaluskar.poc.cutils.basics.helpers.IPUtils;

/**
 * @author sanjay
 *
 */
public class Ip2City extends Function
{
  private static final String NAME             = "ip2city";
  ...
  public Value evaluate(List<Value> arguments)
  {
    ...
    return new Value(Dty.STRING, IPUtils.getCity(s.coerceToString()));
  }
}
